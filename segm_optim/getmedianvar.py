		...
		if done == False and avail2 == True:
			...
			if xoff>0 and yoff>0: #and go == 1:
				...
				if mask2tree.all() == True:
					...
					treepamean = round(np.median(tree_pa),2)
				...
				if mask2epr.all() == True:
					...
					eprpamean = round(np.median(epr_pa),2)
				...
				if mask2pre.all() == True:
					...
					prepamean = round(np.median(pre_pa),2)
				...
				if mask2bio.all() == True:
					...
					biopamean = round(np.median(bio_pa),2)
				...
				if mask2slope.all() == True:
					...
					slopepamean = round(np.median(slope_pa),2)
				...
				if mask2ndwi.all() == True:
					...
					ndwipamean = round(np.median(ndwi_pa),2)
				...
				if mask2ndvimax.all() == True:
					...
					ndvimaxpamean = round(np.median(ndvimax_pa),2)
				...
				if mask2ndvimin.all() == True:
					...
					ndviminpamean = round(np.median(ndvimin_pa),2)
				...
				if mask2herb.all() == True:
					...
					hpamean = round(np.median(herb_pa),2)
