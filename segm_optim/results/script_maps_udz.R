...
# set_defaults(map_service = "esri", map_type = "world_physical_map")
 ...
 hft1_lp<-raster('../../results/30706_19297_1_lp.tif')
 hft2_lp<-raster('../../results/30706_19297_2_lp.tif')
 hft3_lp<-raster('../../results/30706_19297_3_lp.tif')
 hft4_lp<-raster('../../results/30109_19297_4_lp.tif')
 hft5_lp<-raster('../../results/30125_19297_5_lp.tif')
...
# HFTs
hft<-ggplot(data = pa) + annotation_map_tile('stamenwatercolor', zoom=9) + geom_sf(aes(fill = as.factor(hclst_m))) + annotation_scale(location = "tl") + scale_fill_brewer(palette = 'Set1') + ggtitle(label = "Udzungwa Mountains", subtitle = "HFTs") + annotation_north_arrow(location = "br", which_north = "true") + guides(fill=guide_legend("HFT"))

ggsave('hft_udz.png',hft)
