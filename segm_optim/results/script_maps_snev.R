...
# set_defaults(map_service = "esri", map_type = "world_physical_map")
 ...
 hft1_lp<-raster('../../results/81208_555538721_1_lp.tif')
 hft2_lp<-raster('../../results/81208_555538721_2_lp.tif')
 hft3_lp<-raster('../../results/81208_555538721_3_lp.tif')
 hft4_lp<-raster('../../results/81208_555538721_4_lp.tif')
 hft5_lp<-raster('../../results/81208_555538721_5_lp.tif')
...
# HFTs
hft<-ggplot(data = pa) + annotation_map_tile('stamenwatercolor', zoom=8) + geom_sf(aes(fill = as.factor(hclst_m))) + annotation_scale(location = "tl") + scale_fill_brewer(palette = 'Set1') + ggtitle(label = "Sierra Nevada", subtitle = "HFTs") + annotation_north_arrow(location = "tr", which_north = "true") + guides(fill=guide_legend("HFT"))

ggsave('hft_snev.png',hft)
