...
#if mask2ndwi.all() == True: print 'ndwi All nans'
...
#colnpa0 = ['dem_pa','bio_pa','pre_pa','epr_pa','herb_pa','ndvi_pa','ndwi_pa','slope_pa','tree_pa']

#colnpa = colnpa0[cols]

ind_pa0 = np.column_stack((dem_pa,bio_pa,pre_pa,epr_pa,herb_pa,ndvi_pa,ndwi_pa,slope_pa,tree_pa))

#ind_pa = np.column_stack((colnpa))
