...
# ehab_optim.py uses np.mean; ehab_optim_median.py is generated from this file with
# AGG = np.median and SIM_LABEL = 'MedianHFTSim'. Note: the per-variable *pamean
# columns always use np.mean in BOTH variants (this matches the original code).
AGG = np.mean
SIM_LABEL = 'AveHFTSim'
