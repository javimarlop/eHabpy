...
n = 0
radar.plot([df[n,][5]*5/75, df[n,][0], df[n,][2]*5/1.5, df[n,][3]*5/7.5, df[n,][4]*5/0.75],  '-', lw=2, color='b', alpha=0.4, label='first')

fig.suptitle('Okavango', size=16, y = 1, ha = 'right')

fig.savefig('rdplot_oka.png', bbox_inches='tight')
